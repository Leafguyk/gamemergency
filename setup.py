...
setup(
    ...
    description         = 'minigame library',
    # 배포하는 사람의 이름을 작성합니다.
    author              = 'Leafguyk, qwerdf12345677, jennyiris06, aslkf',
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email        = 'leafguykk@gmail.com',
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url                 = 'https://github.com/Leafguyk/gamemergency',
    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'https://github.com/Leafguyk/gamemergency/archive/master.zip',
